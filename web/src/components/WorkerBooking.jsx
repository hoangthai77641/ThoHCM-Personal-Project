...
const WorkerBooking = ({ selectedService }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const successMessage = `Đặt lịch thành công!\n\nDịch vụ: ${selectedService.name}\nThời gian: ${preferredTime.toLocaleString('vi-VN')}\nĐịa chỉ: ${address}\n\nBạn sẽ được chuyển đến trang "Đơn của tôi" để xem chi tiết đơn hàng.`;
    ...
    <div className="worker-booking">
      <div className="booking-info">
        ...
        <div className="service-info">
          ...
          <p>
            <strong>Thợ:</strong> {selectedService.worker?.name || 'Chưa có thông tin'}
            {selectedService.worker?.isOnline === false && (
