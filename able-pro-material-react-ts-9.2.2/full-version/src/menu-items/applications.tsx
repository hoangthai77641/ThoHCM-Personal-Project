...
import { NotificationStatus, CalendarEdit } from 'iconsax-react';
...
const applications: NavItemType = {
  ...
  type: 'group',
  // Only show this group to authenticated users (role check handled globally)
  children: [
    {
      id: 'chat',
